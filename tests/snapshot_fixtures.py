...
DAMAGED_NAMES = (
    ...
    ("乌兰察布恒通云数据中fw", "Ulanqab Hengtong Cloud Data Center"),
    (
        "内蒙古联创信科绿色智算中X8",
        "Inner Mongolia Lianchuang Xinke Green Intelligent Computing Center",
    ),
    (
        "寰宇科技乌兰察布云智算中心一号基XM",
        "Huanyu Technology Ulanqab Cloud Computing Center Base No. 1",
    ),
)
...
INTACT_NAMES = (
    ...
    "Ulanqab Hengtong Cloud Data Center",
    "Yunqi",
    "",
)
